...
class CategoryMenuCest
{
		...
		*/
		...
		{	
				$this->categoryTitle = 'Main Category 101';
				$this->articleTitle = 'Main Article 101';
				$this->articleContent = 'Every Thing 101 : Hello World 101 ';
				$this->menuItemName = 'Menu Item 202';
				$this->menuItemAlias = 'MI202';
		}
		/**
		 * Create Category
		 *
